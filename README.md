...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10245&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multiprocessing-logging-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multiprocessing-logging` can be installed with:

```
conda install multiprocessing-logging
```

It is possible to list all of the versions of `multiprocessing-logging` available on your platform with:
